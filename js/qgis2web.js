...
function addLayerToSidebar(layer, name) {
  var sidebarDiv = document.getElementById("layerControl");

  // Cari grup "Uploaded Layers"
  var groupContainer = sidebarDiv.querySelector("#uploaded-layers-group");
  if (!groupContainer) {
    groupContainer = document.createElement("div");
    groupContainer.id = "uploaded-layers-group";
    groupContainer.innerHTML = "<h4>Uploaded Layers</h4>";
    sidebarDiv.prepend(groupContainer);
  }
